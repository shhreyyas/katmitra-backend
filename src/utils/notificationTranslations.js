...
const notificationTranslations = {
  eventReminder: {
    ...
    gu: ({ eventType, forSuffix, datePhrase, venue, guests }) => {
      ...
      return { title: "📅 કાર્યક્રમ રિમાઇન્ડર", body: lines.join("\n") };
    },
  },
  ...
  bookingNoEvents: {
    ...
    gu: ({ forSuffix }) => ({
      title: "તમારા કાર્યક્રમો ભૂલશો નહીં! 📅",
      body: `તમે એક બુકિંગ બનાવી${forSuffix} પણ હજુ સુધી કોઈ કાર્યક્રમ ઉમેર્યો નથી. હમણાં કાર્યક્રમ ઉમેરવા માટે ટેપ કરો.`,
    }),
  },
  ...
  eventNoMenu: {
    ...
    gu: ({ forSuffix }) => ({
      ...
      body: `તમે એક કાર્યક્રમ બનાવ્યો${forSuffix} પણ હજુ સુધી મેનુ પસંદ કર્યું નથી. હમણાં મેનુ પસંદ કરવા માટે ટેપ કરો.`,
    }),
  },
  ...
  quotationUpcoming: {
    ...
    gu: ({ clientName }) => ({
      title: "ક્વોટેશન કાર્યક્રમ નજીક છે! 📋",
      body: `${clientName} માટેના તમારા ક્વોટેશનનો કાર્યક્રમ 3 દિવસમાં છે. કૃપા કરીને ખાતરી કરો કે બધું કન્ફર્મ છે.`,
    }),
  },
  ...
  quotationPassed: {
    ...
    gu: ({ clientName }) => ({
      title: "ક્વોટેશન કાર્યક્રમ પસાર થઈ ગયો છે 📋",
      body: `${clientName} માટેના તમારા ક્વોટેશનની કાર્યક્રમ તારીખ પસાર થઈ ગઈ છે. કૃપા કરીને તેની સ્થિતિ અપડેટ કરો.`,
    }),
  },
  ...
  draftUpcoming: {
    ...
    gu: ({ forSuffix }) => ({
      title: "ડ્રાફ્ટ બુકિંગ કાર્યક્રમ નજીક છે! 📝",
      body: `તમારી પાસે એક ડ્રાફ્ટ બુકિંગ છે${forSuffix} જેનો કાર્યક્રમ 3 દિવસમાં છે. હમણાં તેને કન્ફર્મ કરો.`,
    }),
  },
  ...
  draftPassed: {
    ...
    gu: ({ forSuffix }) => ({
      title: "ડ્રાફ્ટ બુકિંગ કાર્યક્રમ પસાર થઈ ગયો છે 📝",
      body: `તમારી ડ્રાફ્ટ બુકિંગ${forSuffix}ની કાર્યક્રમ તારીખ પસાર થઈ ગઈ છે. કૃપા કરીને તેની સમીક્ષા કરો અથવા બંધ કરો.`,
    }),
  },
  ...
  welcome: {
    ...
    gu: () => ({
      ...
      body: "તમે તૈયાર છો. તમારી પહેલી બુકિંગ બનાવો અને કાર્યક્રમો મેનેજ કરવાનું શરૂ કરો.",
    }),
  },
};
